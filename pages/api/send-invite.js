            ...
            <tr>
              <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                  ...
                  <!-- Header -->
                  <tr>
                    <td style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); padding: 40px 30px;">
                  ...
                  <tr>
                    <td style="padding: 40px 30px;">
                      ...
                      <p style="margin: 0 0 20px; color: #374151; font-size: 16px; line-height: 1.6;">
                        <strong>${coachName}</strong> has invited you to join their team:
                      </p>
                      ...
                      <p style="margin: 0 0 30px; color: #374151; font-size: 16px; line-height: 1.6;">
                        Click the button below to create your account and join the team. You'll be able to complete drills, track your progress, and compete with your teammates!
                      </p>
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="center">
                            <a href="${inviteLink}" style="display: inline-block; background-color: #16a34a; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-weight: bold; font-size: 16px;">
                              Join ${teamName}
                            </a>
                          </td>
                        </tr>
                      ...
                      ${coachEmail ? `
                        <p style="margin: 30px 0 0; padding-top: 20px; border-top: 1px solid #e5e7eb; color: #6b7280; font-size: 14px;">
                          Questions? Reply to this email to reach ${coachName} directly.
                        </p>
                      ` : ''}
                    </td>
                  </tr>
